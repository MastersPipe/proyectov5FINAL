...
Route::get('/', [HomeController::class, 'index'])->name('home');
    ...
    Route::middleware(['auth', 'user-access:Docente'])->group(function () {
        ...
        //Route::resource('alumnos', App\Http\Controllers\AlumnoController::class)->middleware('auth');   
        //Route::resource('users', App\Http\Controllers\UserController::class)->middleware('auth');
        //Route::get('/alumno/alumno_index', [AlumnoController::class, 'alumno_index'])->name('alumno_index');
        //Route::resource('/estudiante', App\Http\Controllers\AlumnoController::class)->middleware('auth');  
    });
    ...
    Route::middleware(['auth', 'user-access:Alumno'])->group(function () {
        ...
        //Route::get('/estudiante/{$alumno}', 'AlumnoController@estudiante_show')->name('alumno.estudiante_show');
...
//SUGERENCIA: MODIFICAR RUTAS PARA EVITAR CONFUSION : EJ: informes/alumnos/export
